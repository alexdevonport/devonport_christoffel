...
def comparison_experiment(sampler, nx, epsilon_target, delta, experiment_name='exp'):
    ...
    cfun_nys = KernelCfun(kfun=kfun_se, threshold=threshold_se, noiselevel=noiselevel_se, delta=delta, nx=2, n_nys=1000)
    ...
    figname = '{:s}_{:s}_cmp.png'.format(timestr, experiment_name)
